...
(custom-set-variables
 ...
 '(package-selected-packages
   '(ace-jump-mode auctex avy beacon corfu counsel-projectile csv-mode
                   dired-subtree eglot-fsharp elisp-slime-nav embark-consult
                   eros exec-path-from-shell expand-region flyspell-correct
                   geiser-chez hl-todo idle-highlight-mode imenu-anywhere
                   indent-bars ligature lorem-ipsum macrostep magit marginalia
                   markdown-mode multiple-cursors nerd-icons-completion
                   nerd-icons-corfu nerd-icons-dired orderless org-bullets
                   paredit pdf-tools racket-mode rainbow-delimiters rainbow-mode
                   scala-mode sly-overlay trashed undo-tree vertico wttrin
