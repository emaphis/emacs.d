...
(custom-set-variables
 ...
 '(package-selected-packages
   '(highlight-indentation eglot-fsharp eglot eglot-fharp typescript-mode clojure-mode ivy-rich flyspell-correct-ivy flyspell-correct company-quickhelp company flycheck paredit yasnippet-snippets racket-mode aggressive-indent modus-vivendi-theme modus-operandi-theme lsp-ivy flycheck-clj-kondo dap-mode lsp-java lsp-ui lsp-mode company-erlang fill-column-indicator ivy-erlang-complete faff-theme rainbow-delimiters dante parchment-theme zenburn-theme flycheck-irony irony-eldoc company-irony-c-headers company-irony emidje cider which-key slime nimbus-theme wttrin counsel-projectile lorem-ipsum counsel swiper ace-window inf-ruby org-bullets org-bullet try hl-todo expand-region beacon smooth-scroll smooth-scrolling projectile company-jedi jedi flycheck-joker utop merlin tuareg erlang fsharp-mode yasnippet haskell-mode ess-site ess intero hl-sexp highlight-sexp moe-theme toxi-theme leuven-theme win-switch undo-tree solarized-theme sml-mode smex smartparens rainbow-mode monokai-theme markdown-mode magit idomenu ido-ubiquitous ido-hacks idle-highlight-mode gandalf-theme flycheck-pos-tip ensime elisp-slime-nav edts cyberpunk-theme company-ghc ace-jump-mode))
