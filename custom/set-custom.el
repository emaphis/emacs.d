...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (emidje cider which-key geiser slime nimbus-theme wttrin counsel-projectile yasnippet-snippets lorem-ipsum counsel swiper ace-window inf-ruby org-bullets org-bullet try hl-todo expand-region aggressive-indent beacon smooth-scroll smooth-scrolling projectile company-jedi jedi flycheck-joker utop merlin tuareg erlang fsharp-mode yasnippet haskell-mode ess-site ess intero clj-refactor hl-sexp highlight-sexp moe-theme toxi-theme leuven-theme racket-mode zenburn-theme win-switch undo-tree solarized-theme sml-mode smex smartparens rainbow-mode rainbow-delimiters multiple-cursors monokai-theme markdown-mode magit idomenu ido-ubiquitous ido-hacks idle-highlight-mode gandalf-theme flycheck-pos-tip ensime elisp-slime-nav edts cyberpunk-theme company-ghc ace-jump-mode)))
