...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (intero clj-refactor hl-sexp highlight-sexp moe-theme toxi-theme leuven-theme racket-mode zenburn-theme win-switch undo-tree solarized-theme sml-mode smex smartparens rainbow-mode rainbow-delimiters multiple-cursors monokai-theme markdown-mode magit idomenu ido-ubiquitous ido-hacks idle-highlight-mode gandalf-theme flycheck-pos-tip ess ensime elisp-slime-nav edts cyberpunk-theme company-ghc cider ace-jump-mode))))
(custom-set-faces
